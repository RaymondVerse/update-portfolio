    ...
    <section className="footer">
      <div className="footer-content">
        <div className="footer-content-left">
          <Image
            ...
            alt="Logo"
          />
          <h1 className="subheadline white">Ifeoluwa Abimbola</h1>
      ...
      <div className="footer-content-bottom">
        <p className="small-description grey">
          © 2025 Ifeoluwa Abimbola All Rights Reserved
        </p>
        <div className="footer-socials">
          {/* <Linkedin strokeWidth={1.25} className="footer-socials-icon" /> */}
          <a href="https://www.linkedin.com/in/ifeoluwa-abimbola-83365b36b/" target="_blank">
            <svg
